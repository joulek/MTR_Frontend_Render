...
export default function SiteHeader({ mode = "public", onLogout }) {
  ...
  async function handleLogout() {
    try {
      // 1) Effacer les cookies sur le domaine FRONT (celui que voit le middleware)
      ...
      // 2) (Optionnel) prévenir le backend de fermer sa session si nécessaire
      try {
